...
import com.example.navigation.contract.CustomAction
import com.example.navigation.contract.HasCustomAction
import com.example.navigation.contract.HasCustomTitle
import com.example.navigation.contract.Navigator
import com.example.navigation.contract.ResultListener
...
class MainActivity  : AppCompatActivity(), Navigator {
    ...
    private fun updateUi() {
        ...
        if (fragment is HasCustomTitle) {
            ...
            binding.toolbar.title = getString(R.string.done)
        }
